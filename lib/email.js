...
const FROM = process.env.EMAIL_FROM || 'My Family and I <noreply@bb1stbirninkebbico.xyz>';
...
export async function sendContactEmails(senderName, senderEmail, message) {
  ...
  // 1. Admin Notification (Clean White Background)
  const adminHtml = `
  ...
  // 2. User Auto-Reply (Clean White Background)
  const userHtml = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; background: #ffffff; color: #111827;">
